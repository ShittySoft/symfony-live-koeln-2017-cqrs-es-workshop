...
call_user_func(function () {
    ...
    $app->post('/checkin/{buildingId}', function (Request $request, Response $response) use ($sm) : Response {
        ...
        $commandBus->dispatch(Command\CheckInUser::fromBuildingAndUsername($buildingId, $request->getParsedBody()['username']));
    ...
    $app->post('/checkout/{buildingId}', function (Request $request, Response $response) use ($sm) : Response {
        ...
        $commandBus->dispatch(Command\CheckOutUser::fromBuildingAndUsername($buildingId, $request->getParsedBody()['username']));
